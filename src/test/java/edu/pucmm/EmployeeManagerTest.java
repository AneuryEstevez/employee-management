...
public class EmployeeManagerTest {
    ...
    public void testRemoveEmployee() {
        ...
        assertNotEquals(employee1, employeeManager.getEmployees().get(0));
    }
    ...
    public void testCalculateTotalSalary() {
        ...
        double total = employee1.getSalary() + employee2.getSalary();
        assertEquals(total, employeeManager.calculateTotalSalary());
    }
    ...
    public void testAddEmployeeWithInvalidSalary() {
        ...
        assertThrows(InvalidSalaryException.class, () -> employeeManager.addEmployee(new Employee("3", "Aneury E", juniorDeveloper, 60000)));
        // - Crear otro empleado con un salario de 40000 para seniorDeveloper.
        // - Verificar que se lanza una InvalidSalaryException al agregar este empleado.
        assertThrows(InvalidSalaryException.class, () -> employeeManager.addEmployee(new Employee("3", "Aneury E", seniorDeveloper, 40000)));
    }
